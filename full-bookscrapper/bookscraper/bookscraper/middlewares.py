...
from urllib.parse import urlencode  # will encode our urls
from random import randint          # pick a random integer so we can use that to pick from the list of fake-user-agents
import requests                     

# middle ware to create fake user agents
...
# middleware to create fake headers
